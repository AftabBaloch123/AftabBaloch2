...
jalan("\033[1;97m •◈•───────•◈ Aftab start cloning...•◈•───────•◈•") 
...
jalan("   \033[1;93m Welcome to Itx Aftab × Maha Gull cloning Tool ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mEvildevil\033[1;96m•◈•──────────•◈•")
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.facebook.com/groups/itxfahdi')
...
def pilih_super():
	...
	jalan('                    \033[1;97mFahdi × maha start cloning ...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
